...
stations = [
    ("172.16.103.4", 5001, (-12.240, -38.950)),
    ("172.16.103.5", 5002, (-12.265, -38.950)),
    ("172.16.103.6", 5003, (-12.253, -38.972))
]
...
def infoAlert(nearestStation, car):
    ...
    if 200 <= response.status_code < 300:
        ...
        print(f"Va para o posto {idStation} a {station[1]} km")
        print(f"tem {station[2]} carros nesse posto com um tempo gasto de {station[0]} min")
    else:
